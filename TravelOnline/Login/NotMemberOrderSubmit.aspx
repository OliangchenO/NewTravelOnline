<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotMemberOrderSubmit.aspx.cs" Inherits="TravelOnline.Login.NotMemberOrderSubmit" %>
<!DOCTYPE HTML>
<html>
<head>
	<title>免登陆下单 - 上海青旅官网</title>
	...
	<div class="reg-content clearfix">
		<div class="regbox fl">
			...
			<div class="reg-form">
                ...
                <dl><dd><span>*小提示：成功下单后可在官网顶部“我的青旅-非会员订单”中查看订单详情</span></dd></dl>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".reg-btn").click(function () {
                ...
                var url = "AjaxService.aspx?action=NotMemberOrderSubmit&r=" + Math.random();
        ...
        $("#Button1").click(function () {
            ...
            time(this);
            var url = "/Users/AjaxService.aspx?action=SendNotMemSMS&flag=ordersubmit&r=" + Math.random();
            $.post(url, $("#submit_form").serialize(), function (data) {
                var obj = eval(data);
                if (obj.success) {
