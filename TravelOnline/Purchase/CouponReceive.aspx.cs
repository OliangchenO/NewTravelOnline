...
{
    public partial class CouponReceive : System.Web.UI.Page
    {
        ...
        protected void LoadCoupon()
        {
            ...
            if (DS.Tables[0].Rows.Count > 0)
            {
                ...
                if (ff < nums)
                {
                    BuyButton = "<A id=\"OrderBtn\" class=\"btn-link btn-personal\" href=\"javascript:void(0);\" onclick=\"GoToOrder()\">立即领用</A>";
                }
                else
                {
                    BuyButton = "<A id=\"OrderBtn\" class=\"btn-link btn-personal\" href=\"javascript:void(0);\">已领完</A>";
                }
            }
            else
            {
