		    ...
		    <div class="left_part">
                ...
                <div class="left_Recommend">
                    ...
                    <div id="Div6" class="Recommend_box">
                        <ul class="Journal"><% =TravelOnline.tour.LineRecommend.LeftLineRecommendSellCache("LeftLineJournal", linetype, province.ToString(), 9)%></ul>
                    </div>
                </div>
                <div class="left_Recommend">
            ...
            <div class="right_part">
                <div class="x_mod_tab">
                    ...
                    <div class="x_mod_tab_bd <%=LineListInfo %>">
                        ...
                        <div class="right_intro <%=VisaFileHide %>">
                            <div class="Recommend_title">签证文档下载</div>
                            <div class="right_introbox">
                                <%=VisaFileInfo %>
                            </div>
                        </div>
                    ...
                    <h1>签约方式</h1>
                        <ul>
                            <li><strong>传真签约：</strong>双方在合同上签字盖章后，通过传真进行签约。</li>
                            <li><strong>快递签约：</strong>我们把盖章合同快递到您，您签字后快递回我们公司，完成签约。</li>
                            <%=ContractInfos %>
                        </ul>
                    </div>
                    ...
                    <h1>付款方式</h1>
                        <ul>
                            <li><strong>在线支付：</strong>支付宝、快钱等多种在线支付方式，供您选择。</li>
                            <li><strong>门店付款：</strong>您可以到距离你最近的门店，完成付款。</li>
                        </ul>
                    </div>
