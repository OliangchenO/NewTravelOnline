<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fx_register.aspx.cs" Inherits="TravelOnline.WeChat.Fx_register" %>
...
<div class="main">
    <div class="wraper" style="padding-left:10px;">
        <h2 class="green">上青旅分销用户注册</h2>
        <form class="registerform" id="registerform">
            <input type="hidden" id="random" name="random" />
            <table style="table-layout:fixed;">
                <tr>
                    <td style="width:70px;">手机号<b>*</b></td>
                    <td style="width:205px;"><input type="text"  maxlength="11" name="mobile" id="mobile" class="inputxt"  placeholder="请填写手机号" /></td>
                </tr>
                ...
                <tr>
                    <td style="width:70px;">短信验证<b>*</b></td>
                    <td style="width:205px; position: relative;">
                        <input type="text" class="inputxt"  maxlength="4" name="Phoneyzm" id="Phoneyzm" placeholder="请查收手机短信，并填写验证码" />
                        <INPUT id="Button1" name="Button1" value="免费获取验证码" type="button" />
                    </td>
                    <div class="reg-error Phoneyzm_e"></div>
                </tr>
                <tr>
                    <td>密码：<b>*</b></td>
                    <td><input type="password" id="userpassword" name="userpassword" class="inputxt" placeholder="请输入密码" datatype="*6-16" nullmsg="请设置密码！" errormsg="密码范围在6~16位之间！" /></td>
                </tr>
                <tr>
                    <td>确认密码：<b>*</b></td>
                    <td><input type="password" id="userpassword2" name="userpassword2" class="inputxt" placeholder="请确认密码" datatype="*" recheck="userpassword" nullmsg="请再输入一次密码！" errormsg="您两次输入的账号密码不一致！" /></td>
                </tr>
                <tr>
                    <td style="width:70px;">用户名</td>
                    <td style="width:205px;"><input type="text" value="" id="username" name="username" placeholder="请输入用户名" class="inputxt" /></td>
                </tr>
                <tr>
                    <td style="width:70px;">邮箱地址</td>
                    <td style="width:205px;"><input type="text" name="email" id="email" class="inputxt" placeholder="请输入邮箱地址"  datatype="e"  errormsg="邮箱格式不正确" nullmsg="请填写邮箱地址" /></td>
                </tr>
                <tr>
                    <td style="width:70px;">微信号</td>
                    <td style="width:205px;"><input type="text" id="wxid" name="wxid" placeholder="请输入微信号" class="inputxt" /></td>
                </tr>
                <tr>
                    <td style="width:70px;">微店名称</td>
                    <td style="width:205px;"><input type="text" id="storename" name="storename" placeholder="请输入微店名称" class="inputxt" /></td>
                </tr>
                <tr>
                    <td style="width:70px;">座机号</td>
                    <td style="width:205px;"><input type="text" maxlength="11" id="tel" name="tel" placeholder="请输入座机号" class="inputxt" /></td>
                </tr>
                <tr>
                    <td style="width:70px;">地址</td>
                    <td style="width:205px;"><input type="text" id="address" name="address" placeholder="请输入地址" class="inputxt" /></td>
                </tr>
                <tr>
                    <td></td>
...
<script type="text/javascript">
    ...
    $(".reg-btn").click(function () {
        ...
        var url = "AjaxService.aspx?action=FxReg&r=" + Math.random();
    ...
    $("#Button1").click(function () {
        if ($("#mobile").val().length < 11) {
            $('.mobilePhone_e').html("手机号长度必须是11位");
            return false;
        }
