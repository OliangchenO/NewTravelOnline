            ...
            <div class="recommend_detail">
                <div class="recommend_txt">
                    ...
                    <div class="tiles row">
                        ...
                        <div class="col-xs-12">
                            <a href="javascript:;" id="myintegral">
                                <div class="tile1 bg-CARROT">
		                            <div class="tile1-body">
			                            <i class="fa fa-tags"></i>
		                            </div>
                        ...
                        <div style="text-align: center;">
                              <input type="button" id="btnLogout" value="退出登录" style="margin-right: auto;margin-left: auto;color: white; background-color:red; width: 22%; height: 40px; border-radius: 15px; border: 0px;" />
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $('#myintegral').live("click", function () {
        url = "../../WeChat/AjaxService.aspx?action=CheckOnline&r=" + Math.random();
        $.cookie("loginstep", "myintegral", { expires: 30, path: '/WeChat' });
        $.get(url, function (obj) {
            if (obj.success) {
    ...
    $('#btnLogout').live("click", function () {
        url = "../../WeChat/AjaxService.aspx?action=Logout&r=" + Math.random();
        $.cookie("loginstep", "myorder", { expires: 30, path: '/WeChat' });
        $.get(url, function (obj) {
            state = { action: "login", url: "#login" };
            history.pushState(state, "用户登录", "#login");
