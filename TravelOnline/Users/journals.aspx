<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="journals.aspx.cs" Inherits="TravelOnline.Users.journals" %>
...
href="/users/UserHome.aspx">会员中心</A>&nbsp;&gt;&nbsp;<SPAN>我的游记</SPAN></DIV>


 <DIV class="m select">
    <form id="formlogin" runat="server">
    <DIV class=mt>
        <H1></H1><STRONG>我的游记</STRONG>
    </DIV>
    <div class="toolbar">&nbsp;
