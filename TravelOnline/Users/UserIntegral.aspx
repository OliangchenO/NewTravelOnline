<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserIntegral.aspx.cs" Inherits="TravelOnline.Users.UserIntegral" %>
...
href="/users/UserHome.aspx">会员中心</A>&nbsp;&gt;&nbsp;<SPAN>我的积分</SPAN></DIV>


 <DIV class="m select">
    <form id="formlogin" runat="server">
    <DIV class=mt>
        <H1></H1><STRONG>积分查询</STRONG>
    </DIV>
    <div class="toolbar">&nbsp;
        <div class="fl" style="padding-left:20px">当前可用积分: <b><%=Allintegral%></b></div>
        <asp:DropDownList ID="DropDownList1" runat="server" Width="120">
            <asp:ListItem Value="1">最近一个月积分</asp:ListItem>
            <asp:ListItem Value="2">历史积分</asp:ListItem>
        </asp:DropDownList>
        &nbsp;
    ...
    <DIV id=explain class="datagrid">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
	        ...
	        <Columns>
                ...
                <%--<asp:BoundField DataField="enddate" HeaderText="到期时间" SortExpression="enddate" DataFormatString="{0:yy-MM-dd}">
		            <HeaderStyle Width="9%" />
                </asp:BoundField>--%>
	        </Columns>
            <PagerTemplate>
