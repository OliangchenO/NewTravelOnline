<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComOrder.aspx.cs" Inherits="TravelOnline.Users.ComOrder" %>
    ...
    <DIV id=explain class="datagrid">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
	        ...
	        <Columns>
                ...
                <asp:BoundField DataField="Pay" HeaderText="返利" SortExpression="Price">
		            <HeaderStyle Width="10%" />
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundField>
