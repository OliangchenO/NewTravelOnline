...
namespace TravelOnline.WeiXinPay
{
    ...
    {
        //在网站根目录下创建日志目录
        //public static string path = HttpContext.Current.Request.FilePath;
        ...
        public static void Debug(string className, string content)
        {
            ...
            {
                WriteLog("Log.DEBUG", className, content);
            }
        }
        ...
        */
        public static void Info(string className, string content)
        {
            ...
            {
                WriteLog("Log.INFO", className, content);
            }
        }
        ...
        */
        public static void Error(string className, string content)
        {
            ...
            {
                WriteLog("Log.ERROR", className, content);
            }
        }
