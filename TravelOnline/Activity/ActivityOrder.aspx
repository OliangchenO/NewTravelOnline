<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivityOrder.aspx.cs" Inherits="TravelOnline.ActivityOrder" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        #lbltable{ border-left:1px solid #efefef;border-top:1px solid #efefef;border-bottom:1px solid #efefef; font-family:"微软雅黑", "宋体", Arial, Lucida, Verdana, Helvetica, sans-serif; font-size:12px;}
        #lbltable th{border-right:1px solid #efefef; height:25px; color:#FFFFFF}
        #lbltable td{border-right:1px solid #efefef; height:25px;}
        </style>
...
href="/Management/ManageHome.aspx">管理中心首页</A>&nbsp;&gt;&nbsp;<SPAN>活动报名情况</SPAN></DIV>

 <DIV class="m select">
    <form id="formlogin" runat="server">
    <DIV class=mt>
        <H1></H1><STRONG>活动报名情况</STRONG>
    </DIV>
    <div class="serchbar">
    <asp:TextBox ID="txbActInfoMain_ID" runat="server" Visible="false"></asp:TextBox>
        活动名称：<asp:TextBox ID="txbAct_Name" runat="server" Width="120px"></asp:TextBox>订单号：<asp:TextBox 
            ID="txbOL_OrderID" runat="server" Width="120px"></asp:TextBox>
        手机号：<asp:TextBox ID="txbMobile" runat="server" Width="120px"></asp:TextBox>
        儿童姓名：<asp:TextBox ID="txbGuestName" runat="server" Width="60px"></asp:TextBox>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" 
                    ...
                    SortExpression="ActOrderID" SortDirection="ASC" 
	                ...
	                <Columns>
                        ...
                        <asp:BoundField DataField="ActInfoMain_ID" HeaderText="活动ID号" 
                            SortExpression="ActOrderID" />
                        <asp:BoundField DataField="ActOrderID" HeaderText="订单号" SortExpression="ActOrderID">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="GuestName" HeaderText="姓名" SortExpression="ActOrderID">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ActName" HeaderText="活动名称" SortExpression="ActOrderID">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="JoinTime" HeaderText="报名时间" SortExpression="ActOrderID">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="PlanNo" HeaderText="分团号" SortExpression="ActOrderID">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
...
<DIV class=clr></DIV></DIV>
    ...
    <script type="text/javascript">
        ...
        function DisableActOrder(ActInfoMain_ID, ActOrderID) {
            if (confirm('确认要取消吗？')) {
            }
            else
            { return false; }
            var url = "AjaxService.aspx?action=DisableActOrder&ActOrderID=" + ActOrderID + "&ActInfoMain_ID=" + ActInfoMain_ID + "&r=" + Math.random();
