<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfo.aspx.cs" Inherits="TravelOnline.Company.UserInfo" %>
    ...
    <form id="form1" runat="server">
        <div class="main">
            <div class="serchbar">
                ...
                姓名: <asp:TextBox class=ipt ID="tb_city" runat="server" Width="80" MaxLength="20"></asp:TextBox> &nbsp;&nbsp;&nbsp;
                        ...
                        <DIV id=explain class="datagrid">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
	                            ...
	                            <Columns>
                                    ...
                                    <asp:BoundField DataField="UserEmail" HeaderText="邮件地址" SortExpression="UserEmail">
		                                <HeaderStyle Width="15%" />
                                    </asp:BoundField>
...
<DIV class=clr></DIV></DIV>
    ...
    <script type="text/javascript">
        function Add() {
            var url = "UserDetail.aspx";
            var dg = new $.dialog({ id: 'No1', page: url, title: '新增用户信息', width: 500, height: 420, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }

        function Edit(id) {
            var url = "UserDetail.aspx?Cid=" + id;
            var dg = new $.dialog({ id: 'No1', page: url, title: '修改用户信息详情', width: 500, height: 420, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }
        ...
        function Del() {
            ...
            var url = "AjaxService.aspx?action=DeleteUser&Id=" + arrChk + "&r=" + Math.random();
