<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CruisesLineOrder.aspx.cs" Inherits="TravelOnline.CruisesOrder.CruisesLineOrder" %>
...
<form id="form1" runat="server">
            ...
            <div class="serch">
                ...
                &nbsp;状态: <asp:DropDownList ID="DropDownList1" runat="server">
                 ...
                 <asp:DropDownList ID="DropDownList2" runat="server">
                    <asp:ListItem Value="all">全部</asp:ListItem>
                    <asp:ListItem Value="2">同行</asp:ListItem>
                    <asp:ListItem Value="1">门店</asp:ListItem>
                    <asp:ListItem Value="0">散客</asp:ListItem>
                 </asp:DropDownList>&nbsp;&nbsp;
            ...
            <div class="long">
                <DIV id=explain class="datagrid2">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        SortDirection="DESC" PageSize="100" ShowFooter="True">
	                    ...
	                    <Columns>
                            ...
                            <asp:BoundField DataField="rooms" HeaderText="间数" SortExpression="rooms">
		                        <HeaderStyle Width="4%" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="标记"  SortExpression="combineid">
                                <ItemTemplate>
                                </ItemTemplate>
                                <HeaderStyle Width="10%" />
                            </asp:TemplateField> 
        ...
        <div id="toolbars" class="tips">
	        <div class="tips-text">
               ...
               <a id=A15 href="javascript:void(0);" class="easyui-linkbutton" plain="true" iconCls="icon-edit">改联系人</a>
...
<uc3:ManagerFooter ID="ManagerFooter1" runat="server" />
    <script type="text/javascript">
        ...
        function FuJia(id) {
            var url = "FuJia.aspx?OrderId=" + id;
            var dg = new $.dialog({ id: 'No1', page: url, title: '修改联系人信息', width: 600, height: 400, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }
        ...
        $('.Doit').bind('click', function () {
            ...
            $("#A15").unbind('click').click(function () { FuJia(orderid); });
        });
