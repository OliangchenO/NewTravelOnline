<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LineCarNo.aspx.cs" Inherits="TravelOnline.Cruises.LineCarNo" %>
...
<head id="Head1" runat="server">
    <title><%=CruisesShip %> - 观光车号分配</title>
...
<form id="form1" runat="server">
        <div class="main">
            <div id="order_title">
            <h2 class="headline"><SPAN class=headstep><%=CruisesShip%> - 观光车号分配</SPAN></h2>
            </div>
            <DIV id="DIV1" style="DISPLAY:none">
                <input id="Cid" name="Cid" type="hidden" value="<%=lineid %>"/>
            </DIV>
            <div class="serch">
                车号: <asp:TextBox class=text ID="tb_cname" runat="server" Width="50px" MaxLength="10"></asp:TextBox> 
                ...
                <a href="javascript:void(0);" class="easyui-linkbutton" plain="false" iconCls="icon-add" onclick="Import()">新增车号</a>&nbsp;&nbsp;
                <a href="javascript:void(0);" class="easyui-linkbutton" plain="false" iconCls="icon-no" onclick="GroupDo('Delete')">删除车号</a>&nbsp;&nbsp;
                <%--<a href="javascript:void(0);" class="easyui-linkbutton" plain="false" iconCls="icon-no" onclick="GroupDo('Cancel')">取消分配</a>--%>
                <a id="A1" href="javascript:" class="easyui-linkbutton" plain="false" onclick="OutPut('AllCar')">车号选择导出</a>&nbsp;&nbsp;
                <a id="A2" href="javascript:" class="easyui-linkbutton" plain="false" onclick="OutPut('JapanCar')">日本用车</a>
            </div>
                        ...
                        <DIV id=explain class="datagrid2">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
	                            ...
	                            <Columns>
                                    ...
                                    <asp:BoundField DataField="BusNo" HeaderText="车号" SortExpression="BusNo">
		                                <HeaderStyle Width="10%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="vtitle" HeaderText="观光类型" SortExpression="vtitle">
                                    ...
                                    <asp:BoundField DataField="berth" HeaderText="座位数" SortExpression="berth">
		                                <HeaderStyle Width="10%" />
                                    </asp:BoundField>
...
<uc3:ManagerFooter ID="ManagerFooter1" runat="server" />
    <script type="text/javascript">
        ...
        function Import() {
            var url = "LineCarNoAllot.aspx?flag=CarNo&lineid=" + $("#Cid").val();
            var dg = new $.dialog({ id: 'No1', page: url, title: '新增车号', width: 650, height: 400, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }

        function edit(id) {
            var url = "LineCarNoAllot.aspx?flag=CarNo&carid=" + id;
            var dg = new $.dialog({ id: 'No1', page: url, title: '修改车号', width: 650, height: 400, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }
