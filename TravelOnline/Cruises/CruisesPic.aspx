<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CruisesPic.aspx.cs" Inherits="TravelOnline.Cruises.CruisesPic" %>
...
<form id="form1" runat="server">
        <div class="main">
            <div id="order_title">
            <h2 class="headline"><SPAN class=headstep>船队及房间图片</SPAN></h2>
            </div>
            ...
            <div class="serch"> 名称: 
                <asp:TextBox class=text 
                    ID="tb_cname" runat="server" Width="162px" MaxLength="50"></asp:TextBox> 
                &nbsp; 类型: <asp:DropDownList ID="DropDownList1" 
                    runat="server">
                    <asp:ListItem>全部</asp:ListItem>
                    <asp:ListItem Value="ship">邮轮外观</asp:ListItem>
                    <asp:ListItem Value="others">各项设施</asp:ListItem>
                    <asp:ListItem Value="deck">甲板</asp:ListItem>
                    <asp:ListItem Value="room">舱房</asp:ListItem>
                </asp:DropDownList>
                &nbsp;&nbsp;
                        ...
                        <DIV id=explain class="datagrid2">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
	                            ...
	                            <Columns>
                                    ...
                                    <asp:BoundField DataField="cname" HeaderText="图片名称" SortExpression="cname">
...
<script type="text/javascript">
    function Add() {
        var url = "CruisesPicAdd.aspx?shipid=" + $("#Cid").val();
        var dg = new $.dialog({ id: 'No1', page: url, title: '增加图片', width: 580, height: 450, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
        dg.ShowDialog();
    }

    function Edit(id) {
        var url = "CruisesPicAdd.aspx?Cid=" + id;
        var dg = new $.dialog({ id: 'No1', page: url, title: '修改图片', width: 580, height: 450, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
        dg.ShowDialog();
    }
    ...
    function DeleteSelect() {
        ...
        var url = "AjaxService.aspx?action=DeleteCruisesPic&Id=" + arrChk + "&r=" + Math.random();
