<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CruisesShip.aspx.cs" Inherits="TravelOnline.Cruises.CruisesShip" %>
...
<form id="form1" runat="server">
        <div class="main">
            <div id="order_title">
            <h2 class="headline"><SPAN class=headstep><%=CruisesCompany %> - 船队</SPAN></h2>
            </div>
            ...
            <div class="serch">
                ...
                &nbsp;系列: <asp:DropDownList ID="DropDownList1" runat="server" DataTextField="dataname" DataValueField="id" Width="150px"></asp:DropDownList>
                &nbsp;&nbsp;
                        ...
                        <DIV id=explain class="datagrid2">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
	                            ...
	                            <Columns>
                                    ...
                                    <asp:BoundField DataField="seriesname" HeaderText="系列" SortExpression="seriesname">
		                                <HeaderStyle Width="10%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="cname" HeaderText="船队名称" SortExpression="cname">
		                                <HeaderStyle Width="25%" />
                                        <ItemStyle HorizontalAlign="left" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="tonnage" HeaderText="吨位" SortExpression="tonnage">
		                                <HeaderStyle Width="10%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="deck" HeaderText="甲板" SortExpression="deck">
		                                <HeaderStyle Width="5%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="capacity" HeaderText="载客量" SortExpression="capacity">
		                                <HeaderStyle Width="5%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="rooms" HeaderText="房间数" SortExpression="rooms">
		                                <HeaderStyle Width="5%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="haveroom" HeaderText="房型" SortExpression="haveroom">
		                                <HeaderStyle Width="5%" />
                                    </asp:BoundField>
...
<uc3:ManagerFooter ID="ManagerFooter1" runat="server" />
    <script type="text/javascript">
        function Add() {
            var url = "CruisesShipAdd.aspx?comid=" + $("#Cid").val();
            var dg = new $.dialog({ id: 'No1', page: url, title: '增加船队', width: 750, height: 500, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }

        function Edit(id) {
            var url = "CruisesShipAdd.aspx?Cid=" + id;
            var dg = new $.dialog({ id: 'No1', page: url, title: '修改船队', width: 750, height: 500, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }
