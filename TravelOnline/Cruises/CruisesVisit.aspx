<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CruisesVisit.aspx.cs" Inherits="TravelOnline.Cruises.CruisesVisit" %>
...
<head id="Head1" runat="server">
    <title><%=CruisesShip %> - 岸上观光线路</title>
...
<form id="form1" runat="server">
        <div class="main">
            <div id="order_title">
            <h2 class="headline"><SPAN class=headstep><%=CruisesShip%> - 岸上观光线路</SPAN></h2>
            </div>
            <DIV id="DIV1" style="DISPLAY:none">
                <input id="Cid" name="Cid" type="hidden" value="<%=Cid %>"/>
            </DIV>
            <div class="serch">
                线路名称: <asp:TextBox class=text ID="tb_cname" runat="server" Width="150px" MaxLength="50"></asp:TextBox> 
                &nbsp;观光类型: <asp:DropDownList ID="DropDownList1" runat="server" DataTextField="dataname" DataValueField="id" Width="150px"></asp:DropDownList>
                &nbsp; &nbsp;&nbsp;
            ...
            <div class=toolbar>点击已售人数，查看已售订单详情&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                ...
                <a href="javascript:void(0)" onclick="GroupDo('VisitSell')" class=tools><img src="../images/icon/ok.png" class=img20>销售</a>
                <a href="javascript:void(0)" onclick="GroupDo('VisitStopSell')" class=tools><img src="../images/icon/ark_delete.png" class=img20>暂停销售</a>
                    ...
                    <ContentTemplate>
                        <DIV id=explain class="datagrid2">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                OnDataBound="GridView_DataBound" GridLines="None" SortExpression="days" 
	                            ...
	                            <Columns>
                                    ...
                                    <asp:BoundField DataField="vtitle" HeaderText="类型" SortExpression="vtitle">
		                                <HeaderStyle Width="15%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="visitname" HeaderText="观光名称" SortExpression="visitname">
		                                <HeaderStyle Width="20%" />
                                        <ItemStyle HorizontalAlign="left" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="stay" HeaderText="停靠时间" SortExpression="stay">
		                                <HeaderStyle Width="10%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="sight" HeaderText="游览时间" SortExpression="sight">
		                                <HeaderStyle Width="10%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="dinner" HeaderText="用餐" SortExpression="dinner">
		                                <HeaderStyle Width="10%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="price" HeaderText="售价" SortExpression="price">
		                                <HeaderStyle Width="10%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="nums" HeaderText="数量" SortExpression="nums">
		                                <HeaderStyle Width="5%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="orders" HeaderText="已售" SortExpression="orders">
		                                <HeaderStyle Width="5%" />
                                    </asp:BoundField>
...
<uc3:ManagerFooter ID="ManagerFooter1" runat="server" />
    <script type="text/javascript">
        function Add() {
            var url = "CruisesVisitAdd.aspx?lineid=" + $("#Cid").val();
            var dg = new $.dialog({ id: 'No1', page: url, title: '增加岸上观光', width: 750, height: 450, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }

        function Edit(id) {
            var url = "CruisesVisitAdd.aspx?Cid=" + id;
            var dg = new $.dialog({ id: 'No1', page: url, title: '修改岸上观光', width: 750, height: 450, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }
        ...
        function DeleteSelect() {
            ...
            var url = "AjaxService.aspx?action=DeleteCruisesVisit&Id=" + arrChk + "&r=" + Math.random();
        ...
        function GroupDo(flag) {
            ...
            $("input[name$='CheckBox']:checked").each(function () { arrChk += this.value + ","; });
            arrChk = arrChk.substr(0, arrChk.length - 1);
            var url = "AjaxService.aspx?action=VisitGroupDo&flag=" + flag + "&Id=" + arrChk + "&r=" + Math.random();
            $.getJSON(url, function (date) {
                if (date.success == 0) {
