<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CruisesRoom.aspx.cs" Inherits="TravelOnline.Cruises.CruisesRoom" %>
...
<uc3:ManagerFooter ID="ManagerFooter1" runat="server" />
    <script type="text/javascript">
        function Add() {
            ...
            var dg = new $.dialog({ id: 'No1', page: url, title: '增加舱房', width: 750, height: 400, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }

        function Edit(id) {
            var url = "CruisesRoomAdd.aspx?Cid=" + id;
            var dg = new $.dialog({ id: 'No1', page: url, title: '修改舱房', width: 750, height: 400, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }
