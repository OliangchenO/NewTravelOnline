<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CruisesCompany.aspx.cs" Inherits="TravelOnline.Cruises.CruisesCompany" %>
...
href="/Management/ManageHome.aspx">管理中心首页</A>&nbsp;&gt;&nbsp;<SPAN>邮轮公司管理</SPAN></DIV>

 <DIV class="m select">
    <form id="formlogin" runat="server">
    <DIV class=mt>
        <H1></H1><STRONG>邮轮公司管理</STRONG>
    </DIV>
    <div class="serchbar">
        邮轮公司名称：<asp:TextBox ID="TB_Name" class="text" runat="server" Width="150"></asp:TextBox>&nbsp;&nbsp;&nbsp;
            ...
            <DIV id=explain class="datagrid">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowSorting="True"  OnSorting="GridView_Sorting"
	                ...
	                <Columns>
                        ...
                        <asp:BoundField DataField="cname" HeaderText="邮轮公司名称" SortExpression="cname">
		                    <HeaderStyle Width="50%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ships" HeaderText="船队数量" SortExpression="ships">
...
<DIV class=clr></DIV></DIV>
    ...
    <script type="text/javascript">
        $(function () {
            $('#AddNew').dialog({ id: 'No1', page: 'CruisesCompanyAdd.aspx', title: '增加邮轮公司', width: 550, height: 380, fixed: true, btnBar: false, skin: 'aero', iconTitle: false, maxBtn: false, cover: true });
        });

        function EditInfo(id) {
            var url = "CruisesCompanyAdd.aspx?id=" + id;
            var dg = new $.dialog({ id: 'No1', page: url, title: '修改邮轮公司', width: 550, height: 380, fixed: true, btnBar: false, skin: 'aero', iconTitle: false, maxBtn: false, cover: true });
            dg.ShowDialog();
        }
        ...
        function DeleteSelect() {
            ...
            var url = "AjaxService.aspx?action=DeleteCruisesCompany&Id=" + arrChk + "&r=" + Math.random();
