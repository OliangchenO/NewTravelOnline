<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LineRoomAllot.aspx.cs" Inherits="TravelOnline.Cruises.LineRoomAllot" %>
...
<form id="form1" runat="server">
        <div class="main">
            <div id="order_title">
            <h2 class="headline"><SPAN class=headstep><%=CruisesShip%> - 舱位分配</SPAN></h2>
            </div>
            ...
            <div class=toolbar>
                ...
                <a href="CruisesRebateList.aspx?lineid=<%=lineid %>&roomid=<%=roomid %>" class="easyui-linkbutton" plain="false" iconCls="icon-search" target="_blank">优惠查询</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <DIV id=explain class="datagrid2">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
	                            ...
	                            <Columns>
                                    ...
                                    <asp:BoundField DataField="price" HeaderText="第1、2人价" SortExpression="price">
		                                <HeaderStyle Width="10%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="thirdprice" HeaderText="第3、4人价" SortExpression="thirdprice">
		                                <HeaderStyle Width="10%" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="nums" HeaderText="间数" SortExpression="nums">
		                                <HeaderStyle Width="5%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="sellroom" HeaderText="已售" SortExpression="sellroom">
		                                <HeaderStyle Width="5%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="rebates" HeaderText="优惠" SortExpression="rebates">
		                                <HeaderStyle Width="5%" />
                                    </asp:BoundField>
...
<uc3:ManagerFooter ID="ManagerFooter1" runat="server" />
    <script type="text/javascript">
        ...
        function Edit(id) {
            var url = "LineRoomAllotAdd.aspx?Cid=" + id;
            var dg = new $.dialog({ id: 'No1', page: url, title: '修改舱房分配', width: 550, height: 400, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }
        ...
        function DeleteSelect() {
            ...
            $("input[name$='CheckBox']:checked").each(function () { arrChk += this.value + ","; });
            arrChk = arrChk.substr(0, arrChk.length - 1);
            var url = "AjaxService.aspx?action=DeleteCruisesRoomAllot&Id=" + arrChk + "&r=" + Math.random();
