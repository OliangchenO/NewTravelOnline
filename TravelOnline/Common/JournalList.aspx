<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JournalList.aspx.cs" Inherits="TravelOnline.Common.JournalList" %>
...
<div class="right-extra ">
    <div class="crumb"><a href="/index.html">首页</a>&nbsp;&gt;&nbsp;<a href = "/journal.html">游记攻略</a></div><!--crumb end-->
...
<SCRIPT type="text/javascript">
    ...
    function LoadList() {
        var url = "../Travel/AjaxLineList.aspx?action=LoadJournalList&Pages=" + $("#TB_CurrPage").val() + "&RowCount=" + $("#TB_RowCount").val();
