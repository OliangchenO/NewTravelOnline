<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowJournal.aspx.cs" Inherits="TravelOnline.Common.ShowJournal" %>
...
<div class=left>
    ...
    <div class="m rank"><div class="mt"><h2>相关旅游线路</h2></div><div class="mc"><ul class="tabcon"><%=Journal%></ul></div></div><!--rank end-->
</div><!--left end-->
<DIV class=extra></DIV>
<div class="right-extra">
    <div class="crumb"><a href="/index.html">首页</a>&nbsp;&gt;&nbsp;<a href = "/journal.html">游记攻略</a>&nbsp;&gt;&nbsp;<%=NewsTitle %></div><!--crumb end-->
    <DIV id=detail class=m>
    <DIV class=mt>
    <H1><%=NewsTitle %></H1>
    <DIV class=summary>作者：<%=NewsUser %> &nbsp;&nbsp;&nbsp;&nbsp;发表时间：<%=NewsTime %>&nbsp;&nbsp;&nbsp;&nbsp;</DIV></DIV>
