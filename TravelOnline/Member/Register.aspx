...
<head>
    ...
    <%
        Session["UserType"] = "RegisterMember";
    %>
</head>
<body>
	<!--页头Begin-->
	...
	<div class="reg-content clearfix">
		<div class="regbox fl">
			<h2 class="reg-title">注册会员<a class="shback" href="/member/RegisterSHBank.html">上海银行“美好生活卡”客户注册</a></h2>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".reg-btn").click(function () {
                ...
                var url = "AjaxService.aspx?action=Register&r=" + Math.random();
