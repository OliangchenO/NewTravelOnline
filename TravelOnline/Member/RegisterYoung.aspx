<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterYoung.aspx.cs" Inherits="TravelOnline.Member.RegisterYoung" %>
...
<body>
	...
	<h1 class="reg-top">
		...
		<div class="bk-nav">
			<a href="/member/loginYoung.aspx">登录</a>
			<span>|</span>
		...
		<div class="regbox fl">
			...
			<div class="reg-form">
				<dl class="reg-form-line clearfix">
					<dt>手机号</dt>
					<dd>
						<input type="text" class="reg-input" maxlength="11" name="mobilePhone" id="mobilePhone" placeholder="可作为登录用户名">
					</dd>
                ...
                <dl class="reg-form-line clearfix">
                    <dt>验证码</dt>
                    <dd>
                        <input type="text" id="authcode" name="authcode" class="reg-input" tabindex="4" autocomplete="off" MaxLength="4" placeholder="请填写验证码"/>
                    </dd>
                    <label id="authcode_succeed" class="blank"></label> 
                    <label class="img"> 
                        <img id="JD_Verification1" style="WIDTH: 80px; HEIGHT: 30px; CURSOR: pointer" onclick="this.src='../users/VerifyCode.aspx?&uid=<%=123456 %>&yys='+new Date().getTime()" src="../users/VerifyCode.aspx?&uid=<%=123456 %>" alt="" style="cursor:pointer;width:100px;height:26px;"> 
                    </label> 
                ...
                <div class="reg-error companyName_e"></div>
                <dl class="reg-form-line clearfix">
					<dt>领队名称</dt>
					<dd>
						<input type="text" class="reg-input"  name="leaderName" id="leaderName" placeholder="请填写领队名称">
					</dd>
					<b class="pass leaderName"></b>
				</dl>
                <div class="reg-error leaderName_e"></div>
                <dl class="reg-form-line clearfix">
                    <dt>常用邮箱</dt>
                    <dd>
                        <input type="text" class="reg-input" maxlength="50" name="email" id="email" placeholder="">
                    </dd>
				...
				<dl class="reg-form-line pt8 clearfix">
					...
					<dd>
						...
						<span id="js_show_pop" style="color:#0069ca; cursor:pointer;">《上海青旅服务条款》</span>
					</dd>
				</dl>
				<dl class="reg-form-line clearfix">
					<dt>&nbsp;</dt>
        ...
        $(document).ready(function () {
            ...
            form.validate({
                ...
                messages: {
                    ...
                    companyName: {
                        required: "<i></i>请输入单位名称"
                    },
                    leaderName: {
                        required: "<i></i>请输入领队名称"
                    }
                },
            ...
            $(".reg-btn").click(function () {
                ...
                var url = "AjaxService.aspx?action=RegisterYoung&r=" + Math.random();
