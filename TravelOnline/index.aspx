...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="/js/base.TopAd.js"></script>
...
<div class="container">
	<div class="row">
		<div class="span12">
          <div class="sy_mod_f_tit">
                <h3><i class="icon-qrcode" style="margin-top: 6px;"></i> 关注我们</h3>
            </div>
          <div class="guanzhu">
            <div class="guanzhu_min">
              <a class="weixin"></a>
              <div class="guanzhu_info">
                 <h6>上海青旅官方微信</h6>
                 <p>扫描二维码<br/>了解最新旅游资讯</p>
              </div>
            </div>
            <div class="guanzhu_min">
              <a class="xweibo" href="http://weibo.com/scyts" target="_blank"></a>
              <div class="guanzhu_info">
                 <h6>上海青旅官方微博</h6>
                 <a class="lj_guanzhu" href="http://weibo.com/scyts" target="_blank">关注我们</a>
              </div>
            </div>
          </div>
        </div>
