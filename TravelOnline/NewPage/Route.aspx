...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Route.aspx.cs" Inherits="TravelOnline.NewPage.Route" %>
		...
		<div class="span12">
            <div class="rw">
                <TABLE id="PrintA" cellSpacing="0" cellPadding="0" width="100%" align="center" bgColor="#ffffff" border="0">
                    ...
                    <tr class="Noprint" ><td align="center"><A class="btn-link btn-personal" href="javascript:document.execCommand('print');void(0);">行程打印</A> <A class="btn-link btn-personal" href="/Purchase/WordOutPut.aspx?Action=LineRoute&Cid=<%=Cid%>" target="_blank">行程下载</A> <A class="btn-link btn-personal" href="/line.html?id=<%=Cid%>">返回线路</A></td>
	                </tr>
	                <tr>
		                <td>
