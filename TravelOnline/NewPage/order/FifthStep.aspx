<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FifthStep.aspx.cs" Inherits="TravelOnline.NewPage.order.FifthStep" %>
	...
	<div class="narrow clearfix">
        ...
        <div class="orderbox">
            <ul>
                ...
                <li class="cur"><i class="ci gc"><b></b></i><p class="gp">支付成功</p></li>
            </ul>
        </div>
		<div class="pay-finish">
            ...
            <dl>
            	<dd>您已经成功支付<span><em>¥ <%=pay%></em>元</span></dd>
                <dd>订单号<b><%=AutoId %></b></dd>
            </dl>
            <dl>
                <dd>您获得<%=Integral%>积分，将在行程开始十五日后进入您的会员账号！</dd>
            </dl>
            <dl>
            	<dd>您可以<a href="/OrderView/<%=OrderId %>.html" target="_blank">查看订单详情</a>或<a href="/index.html">返回首页</a></dd>
            </dl>
        </div>
	</div>
	<!--正文内容End-->
