<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Header.ascx.cs" Inherits="TravelOnline.NewPage.Header" %>
<!--页头Begin-->
	<div class="header">
			...
			<div class="header-ad sch fl clearfix">
				<div class="sch_l fl">
					...
					<form class="fl" onsubmit="javascript:return checkform(this);" name="search" action="/search.html">
                   		<input type="text" id="js_show_hotseach" name="key" class="fl" value="请输入目的地、主题或关键字" />
                   	</form>
				</div>
				<div class="sch_r fl">
