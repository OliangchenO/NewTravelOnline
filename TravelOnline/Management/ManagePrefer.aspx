<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagePrefer.aspx.cs" Inherits="TravelOnline.Management.ManagePrefer" %>
...
href="/Management/ManageHome.aspx">管理中心首页</A>&nbsp;&gt;&nbsp;<SPAN>旅游线路优惠信息管理</SPAN></DIV>
 ...
 <DIV class="m select">
    ...
    <div class="serchbar">
              ...
              </asp:DropDownList> &nbsp; 线路编号：<asp:TextBox ID="tb_cid" runat="server" Width="150"></asp:TextBox>&nbsp;
              </asp:DropDownList> &nbsp; 出团日期：<asp:TextBox ID="tb_startDate" class="iconDate" runat="server" Width="100"></asp:TextBox>-<asp:TextBox ID="tb_endDate" name="tb_endDate" runat="server" Width="100" class="iconDate"></asp:TextBox></br>
              </asp:DropDownList> &nbsp; 报名日期：<asp:TextBox ID="tb_pStartDate" name="tb_pStartDate" runat="server" Width="150" class="iconDate"></asp:TextBox>-<asp:TextBox ID="tb_pEndDate" name="tb_pEndDate" runat="server" Width="150" class="iconDate"></asp:TextBox>
        ...
        <ContentTemplate>
            <DIV id=explain class="datagrid">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowSorting="True"  OnSorting="GridView_Sorting"
                    ...
                    OnDataBound="GridView_DataBound" GridLines="Vertical" SortExpression="startDate" SortDirection="ASC">
	                ...
	                <Columns>
                        ...
                        <asp:BoundField DataField="LineType" HeaderText="类型" SortExpression="LineType">
                        ...
                        <asp:TemplateField HeaderText="报名日期">
                            <ItemTemplate>
                            </ItemTemplate>
                            <HeaderStyle Width="20%" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="preferAmount" HeaderText="优惠金额" SortExpression="preferAmount">
		                    <HeaderStyle Width="10%" />
                        </asp:BoundField>
...
<DIV class=clr></DIV></DIV>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#AddNew').dialog({ id: 'No1', page: 'PreferInfoAdd.aspx', title: '增加优惠信息', width: 590, height: 580, fixed: true, btnBar: false, skin: 'aero', iconTitle: false, maxBtn: false, cover: true });
        });
...
//            dg.ShowDialog();
        ...
        function EditDes(id) {
            var url = "PreferInfoAdd.aspx?Cid=" + id;
        ...
        function DeleteSelect() {
            ...
            $("input[name$='CheckBox']:checked").each(function () { arrChk += this.value + ','; });
            arrChk = arrChk.substr(0, arrChk.length - 1);
            var url = "AjaxService.aspx?action=DeletePreferInfo&Id=" + arrChk + "&r=" + Math.random();
            $.getJSON(url, function (date) {
                if (date.success == 0) {
