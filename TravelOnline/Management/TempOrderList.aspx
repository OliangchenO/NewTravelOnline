<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TempOrderList.aspx.cs" Inherits="TravelOnline.Management.TempOrderList" %>
...
href="/Management/ManageHome.aspx">管理中心首页</A>&nbsp;&gt;&nbsp;<SPAN>订单列表</SPAN></DIV>

 <DIV class="m select">
    <form id="formlogin" runat="server">
    <DIV class=mt>
        <H1></H1><STRONG>订单列表</STRONG>
    </DIV>
    <div class="serchbar">
    ...
    <DIV id=explain class="datagrid">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
	        ...
	        <Columns>
                ...
                <asp:TemplateField HeaderText="预订人">
                    <ItemTemplate>
                    </ItemTemplate>
                ...
                <asp:BoundField DataField="OrderTime" HeaderText="预订日期" SortExpression="OrderTime" DataFormatString="{0:yy-MM-dd HH:ss:mm}">
		            <HeaderStyle Width="7%" />
                </asp:BoundField>
...
<DIV class=clr></DIV></DIV>
    ...
    <script type="text/javascript">
        ...
        function DeleteOrder(id) {
            ...
            { return false; }
            var url = "AjaxService.aspx?action=DeleteTempOrder&OrderId=" + id + "&r=" + Math.random();
            $.getJSON(url, function (date) {
                if (date.success == 0) {
                    alert("订单删除成功！");
