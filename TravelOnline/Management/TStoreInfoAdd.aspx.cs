...
{
    public partial class TStoreInfoAdd : System.Web.UI.Page
    {
        public string id, name, context, pic, link, ThumbSrc1, tradingAreaId, buttoninfo;
        ...
        {
            string SqlQueryText = string.Format("select * from OL_TStore where id= '{0}'", id);
