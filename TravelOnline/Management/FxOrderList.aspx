<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FxOrderList.aspx.cs" Inherits="TravelOnline.Management.FxOrderList" %>
...
href="/Management/ManageHome.aspx">管理中心首页</A>&nbsp;&gt;&nbsp;<SPAN>订单列表</SPAN></DIV>
 ...
 <DIV class="m select">
    ...
    <DIV class=mt>
        <H1></H1><STRONG>分销订单</STRONG>
    </DIV>
    <div class="serchbar">
        分销用户：<asp:TextBox ID="TB_Name" class="text" runat="server" Width="70"></asp:TextBox>&nbsp;
