<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageTradingArea.aspx.cs" Inherits="TravelOnline.Management.ManageTradingArea" %>
...
href="/Management/ManageHome.aspx">管理中心首页</A>&nbsp;&gt;&nbsp;<SPAN>商圈管理</SPAN></DIV>

 <DIV class="m select">
    <form id="formlogin" runat="server">
    <DIV class=mt>
        <H1></H1><STRONG>商圈管理</STRONG>
    </DIV>
    <div class="serchbar">
            商圈名称：<asp:TextBox ID="tb_cname" runat="server" Width="150"></asp:TextBox>&nbsp;
            ...
            <DIV id=explain class="datagrid">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowSorting="True"  OnSorting="GridView_Sorting"
	                ...
	                <Columns>
                        ...
                        <asp:BoundField DataField="name" HeaderText="商圈名称" SortExpression="name">
		                    <HeaderStyle Width="10%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="flag" HeaderText="标示" SortExpression="flag">
		                    <HeaderStyle Width="10%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="detail" HeaderText="商圈详情" SortExpression="detail">
		                    <HeaderStyle Width="10%" />
...
<DIV class=clr></DIV></DIV>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#AddNew').dialog({ id: 'No1', page: 'TradingAreaInfoAdd.aspx', title: '增加商圈信息', width: 590, height: 580, fixed: true, btnBar: false, skin: 'aero', iconTitle: false, maxBtn: false, cover: true });
        });
        ...
        function EditDes(id) {
            var url = "TradingAreaInfoAdd.aspx?Cid=" + id;
            var dg = new $.dialog({ id: 'No1', page: url, title: '商圈信息修改', width: 600, height: 400, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }

        function SearchTActivity(id) {
        ...
        function DeleteSelect() {
            ...
            var url = "AjaxService.aspx?action=DeleteTradingAreaInfo&Id=" + arrChk + "&r=" + Math.random();
            $.getJSON(url, function (date) {
                if (date.success == 0) {
