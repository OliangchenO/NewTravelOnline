<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageTCoupon.aspx.cs" Inherits="TravelOnline.Management.ManageTCoupon" %>
...
<form id="form1" runat="server">
        <div class="main">
            <div id="order_title">
            <h2 class="headline"><SPAN class="headstep">优惠券管理</SPAN></h2>
            </div>
            <div class="toolbar">
            ...
            <div id=explain class="datagrid">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowSorting="True"  OnSorting="GridView_Sorting"
	                ...
	                <Columns>
                        ...
                        <asp:BoundField DataField="context" HeaderText="优惠券内容" SortExpression="context">
...
<uc3:ManagerFooter ID="ManagerFooter1" runat="server" />
    <script type="text/javascript">
        ...
        $(function () {
            $('#AddNew').dialog({ id: 'No1', page: 'TCouponInfoAdd.aspx?tradingAreaId=' + $('#tradingAreaId').val(), title: '增加优惠券信息', width: 590, height: 580, fixed: true, btnBar: false, skin: 'aero', iconTitle: false, maxBtn: false, cover: true });
        });

        function EditDes(id, tradingAreaId) {
            var url = "TCouponInfoAdd.aspx?Cid=" + id + "&tradingAreaId=" + tradingAreaId;
