<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageTStore.aspx.cs" Inherits="TravelOnline.Management.ManageTStore" %>
...
<form id="form1" runat="server">
        <div class="main">
            <div id="order_title">
            <h2 class="headline"><SPAN class="headstep">店铺管理</SPAN></h2>
            </div>
            <div class="toolbar">
            ...
            <div id=explain class="datagrid">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowSorting="True"  OnSorting="GridView_Sorting"
	                ...
	                <Columns>
                        ...
                        <asp:BoundField DataField="context" HeaderText="内容" SortExpression="context">
		                    <HeaderStyle Width="25%" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
...
<uc3:ManagerFooter ID="ManagerFooter1" runat="server" />
    <script type="text/javascript">
        ...
        $(function () {
            $('#AddNew').dialog({ id: 'No1', page: 'TStoreInfoAdd.aspx?tradingAreaId=' + $('#tradingAreaId').val(), title: '增加优惠券信息', width: 590, height: 580, fixed: true, btnBar: false, skin: 'aero', iconTitle: false, maxBtn: false, cover: true });
        });

        function EditDes(id, tradingAreaId) {
            var url = "TStoreInfoAdd.aspx?Cid=" + id + "&tradingAreaId=" + tradingAreaId;
            var dg = new $.dialog({ id: 'No1', page: url, title: '优惠券信息修改', width: 600, height: 400, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }
