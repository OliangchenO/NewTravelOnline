<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XiRongList.aspx.cs" Inherits="TravelOnline.Management.XiRongList" %>
    ...
    <DIV id=explain class="datagrid">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
	        ...
	        <Columns>
                ...
                <asp:BoundField DataField="xrorderid" HeaderText="禧荣订单" SortExpression="xrorderid">
		            <HeaderStyle Width="8%" />
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundField>
                <asp:BoundField DataField="XiRongLine" HeaderText="传递线路" SortExpression="XiRongLine">
		            <HeaderStyle Width="15%" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:TemplateField HeaderText="回调">
                    <ItemTemplate>
                    </ItemTemplate>
                    <HeaderStyle Width="5%" />
                </asp:TemplateField>
