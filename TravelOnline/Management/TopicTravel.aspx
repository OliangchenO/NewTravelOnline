<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TopicTravel.aspx.cs" Inherits="TravelOnline.Management.TopicTravel" %>
...
href="/Management/ManageHome.aspx">管理中心首页</A>&nbsp;&gt;&nbsp;<SPAN>首页主题旅游</SPAN></DIV>

 <DIV class="m select">
    <form id="formlogin" runat="server">
    <DIV class=mt>
        <H1></H1><STRONG>首页主题旅游设置</STRONG>
    </DIV>
    <div class="toolbar">
        <a id="AddNew" href="javascript:" class="easyui-linkbutton" plain="true" iconCls="icon-add">新增</a>
            ...
            <DIV id=explain class="datagrid">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowSorting="True"  OnSorting="GridView_Sorting"
	                ...
	                <Columns>
                        ...
                        <asp:TemplateField HeaderText="首页隐藏" SortExpression="HideFlag">
...
<DIV class=clr></DIV></DIV>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#AddNew').dialog({ id: 'No1', page: 'TopicTravelInfo.aspx', title: '增加主题旅游', width: 480, height: 350, fixed: true, btnBar: false, skin: 'aero', iconTitle: false, maxBtn: false, cover: true });
        });

        function EditInfo(id) {
            var url = "TopicTravelInfo.aspx?Id=" + id;
            //alert("aa");
            var dg = new $.dialog({ id: 'No1', page: url, title: '修改主题旅游', width: 480, height: 350, fixed: true, btnBar: false, skin: 'aero', iconTitle: false, maxBtn: false, cover: true });
            dg.ShowDialog();
        }
        ...
        function DeleteSelect() {
            ...
            var url = "AjaxService.aspx?action=DeleteAdInfos&AdFlag=Topic&Id=" + arrChk + "&r=" + Math.random();
