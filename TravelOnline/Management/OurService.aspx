<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OurService.aspx.cs" Inherits="TravelOnline.Management.OurService" %>
...
<DIV class=clr></DIV></DIV>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#AddNew').dialog({ id: 'No1', page: 'AfficheInfo.aspx?Flag=2', title: '增加服务信息', width: 680, height: 500, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
        });

        function EditInfo(id) {
            var url = "AfficheInfo.aspx?Flag=2&Id=" + id;
            var dg = new $.dialog({ id: 'No1', page: url, title: '修改服务信息', width: 680, height: 500, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }
