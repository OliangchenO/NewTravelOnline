<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutBoundInfo.aspx.cs" Inherits="TravelOnline.Management.OutBoundInfo" %>
...
href="/Management/ManageHome.aspx">管理中心首页</A>&nbsp;&gt;&nbsp;<SPAN>服务信息设置</SPAN></DIV>

 <DIV class="m select">
    <form id="formlogin" runat="server">
    <DIV class=mt>
        <H1></H1><STRONG>服务信息</STRONG>
    </DIV>
    <div class="serchbar">
        信息标题：<asp:TextBox ID="TB_Name" class="text" runat="server" Width="150"></asp:TextBox>&nbsp;
        板块：<asp:DropDownList ID="DropDownList1" runat="server" Width="100">
            <asp:ListItem Value="全部板块">全部板块</asp:ListItem>
            <asp:ListItem Value="OutBound1">出境须知1</asp:ListItem>
            <asp:ListItem Value="OutBound2">出境须知2</asp:ListItem>
            <asp:ListItem Value="OutBound3">出境须知3</asp:ListItem>
            <asp:ListItem Value="OutBound4">出境须知4</asp:ListItem>
            <asp:ListItem Value="OutBound5">出境须知5</asp:ListItem>
            <asp:ListItem Value="OutBound6">出境须知6</asp:ListItem>
        </asp:DropDownList>
        &nbsp;
            ...
            <DIV id=explain class="datagrid">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowSorting="True"  OnSorting="GridView_Sorting"
	                ...
	                <Columns>
                        ...
                        <asp:BoundField DataField="AfficheName" HeaderText="服务信息标题" SortExpression="AfficheName">
...
<DIV class=clr></DIV></DIV>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#AddNew').dialog({ id: 'No1', page: 'AfficheInfo.aspx?Flag=5', title: '增加出境须知信息', width: 680, height: 500, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
        });

        function EditInfo(id) {
            var url = "AfficheInfo.aspx?Flag=5&Id=" + id;
            var dg = new $.dialog({ id: 'No1', page: url, title: '修改出境须知信息', width: 680, height: 500, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }
