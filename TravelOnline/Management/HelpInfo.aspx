<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HelpInfo.aspx.cs" Inherits="TravelOnline.Management.HelpInfo" %>
 ...
 <DIV class="m select">
    ...
    <div class="serchbar">
        ...
        板块：<asp:DropDownList ID="DropDownList1" runat="server" Width="100">
            ...
            <asp:ListItem Value="Help1">帮助分类1</asp:ListItem>
            <asp:ListItem Value="Help2">帮助分类2</asp:ListItem>
            <asp:ListItem Value="Help3">帮助分类3</asp:ListItem>
            <asp:ListItem Value="Help4">帮助分类4</asp:ListItem>
            <asp:ListItem Value="Help5">帮助分类5</asp:ListItem>
            <asp:ListItem Value="Help6">帮助分类6</asp:ListItem>
        </asp:DropDownList>
        &nbsp;
...
<DIV class=clr></DIV></DIV>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#AddNew').dialog({ id: 'No1', page: 'AfficheInfo.aspx?Flag=3', title: '增加帮助信息', width: 680, height: 500, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
        });

        function EditInfo(id) {
            var url = "AfficheInfo.aspx?Flag=3&Id=" + id;
            var dg = new $.dialog({ id: 'No1', page: url, title: '修改帮助信息', width: 680, height: 500, skin: 'aero', btnBar: false, iconTitle: false, cover: true });
            dg.ShowDialog();
        }
