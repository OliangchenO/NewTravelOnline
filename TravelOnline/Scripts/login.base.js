...
function search(id) {
    ...
    window.location = 'Search?keyword=' + selKey;
}
function loginbak() {
...
function registbak() {
    location.href = "registpersonal.aspx" + location.search;
    return false;
}
function login() {
    location.href = "/login/login.aspx" + location.search;
    return false;
}
function regist() {
