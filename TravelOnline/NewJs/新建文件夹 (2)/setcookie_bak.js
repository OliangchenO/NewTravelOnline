...
function BindHistory() {
    ...
    if (historyp == null && historyp == "") {
        ...
        var CookieGoods = "";
        var strtemp = "";
        //onerror=\"this.src='/Images/none.gif'\"/>
        var str = "<div class=\"record\">" +
	                "<div class=\"record-img\">" +
		                "<a href=\"line.html?id={0}\" title=\"{1}\" target=\"_blank\"><img style='width:231px;height:110px' src=\"{3}\" alt=\"{1}\" </a>" +
	                "</div>" +
	                "<div class=\"record-tit\"><a href=\"line.html?id={0}\" title=\"{1}\" target=\"_blank\">{1}</a></div>" +
	                "<div class=\"record-con\">" +
		                "<div class=\"trip-class blue\">{4}</div>" +
