<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cruises.aspx.cs" Inherits="TravelOnline.Travel.Cruises" %>
...
<body id="read">
    ...
    <div class="right-extra">
        <div class=middle>
            <div id=slide></div>
            <script type="text/javascript" src="/Js/AD/Cruises.js"></script><!--slide end-->
            ...
            <script type="text/javascript" src="/Js/Preferences/Cruises.js"></script>
    ...
    <script type="text/javascript" src="/Js/ProductDetail/Cruises.js"></script>
    <script type="text/javascript">
        $(function () {
