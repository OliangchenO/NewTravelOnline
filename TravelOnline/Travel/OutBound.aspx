<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutBound.aspx.cs" Inherits="TravelOnline.OutBound" %>
...
<body id="pop">
    ...
    <div class="right-extra">
        <div class=middle>
            <div id=slide></div>
            <script type="text/javascript" src="/Js/AD/OutBound.js"></script><!--slide end-->
        ...
        <div class=right>
                    ...
                    <DIV id=pay_service>
                        <DIV class=switch-scroll-panel>
                            <UL class="switch-nav switch-content cls">
                                <LI class=selected><A class=icon-phone href="http://life.baifubao.com/sj?c=youa" target=_blank>手机充值</A> </LI>
                                <LI><A class=icon-game href="http://life.baifubao.com/wy?c=youa" target=_blank>网游充值</A> </LI>
                                <LI><A class=icon-trade href="http://life.baifubao.com/game?c=youa" target=_blank>网游交易</A> </LI>
                                <LI><A class=icon-caipiao href="http://life.baifubao.com/caipiao?c=youa" target=_blank ?>彩票</A> </LI>
                                <LI><A class=icon-coin href="http://life.baifubao.com/coin?c=youa" target=_blank ?>百度币</A> </LI>
                                <LI><A class=icon-piao href="http://life.baifubao.com/piao?c=youa" target=_blank ?>演出票</A> </LI>
                            </UL>
                        </DIV>
                    </DIV>
                </div>
            ...
            <%--<div class="m da211x180" id="OutBound_Right1"><script type="text/javascript" src="/Scripts/AD/OutBound_Right1.js"></script></div>--%>
        </div><!--right end-->
    </div><!--right-extra end-->
...
<%--        <DIV class=special_t class=mt>
            ...
            <DIV class="m special"><DIV id="日韩" class=mc><DIV class=iloading>正在加载中，请稍候...</DIV></DIV>
        </DIV>
        <DIV class=special_t class=mt>
            <H2>港澳专区</H2>
            <DIV class=extra><A href="/products/1.html">更多&gt;&gt;</A></DIV></DIV>
            <DIV class="m special"><DIV id="港澳" class=mc><DIV class=iloading>正在加载中，请稍候...</DIV></DIV>
        </DIV>
        <DIV class=special_t class=mt>
            <H2>中东非洲专区</H2>
            <DIV class=extra><A href="/products/1.html">更多&gt;&gt;</A></DIV></DIV>
            <DIV class="m special"><DIV id="中东非洲" class=mc><DIV class=iloading>正在加载中，请稍候...</DIV></DIV>
        </DIV>
        <DIV class=special_t class=mt>
            <H2>东南亚专区</H2>
            <DIV class=extra><A href="/products/1.html">更多&gt;&gt;</A></DIV></DIV>
            <DIV class="m special"><DIV id="东南亚" class=mc><DIV class=iloading>正在加载中，请稍候...</DIV></DIV>
        </DIV>--%>
    </div><!--right-extra end-->
    </div><!--w main end-->
    <SPAN class=clr></SPAN>
    ...
    <script type="text/javascript" src="/Js/ProductDetail/OutBound.js"></script>
    <script type="text/javascript">
        $(function () {
