...
namespace Com.Alipay
{
    ...
    public class Notify
    {
        ...
        //1、接口请求网关www.alipay.com（https://www.alipay.com/cooperate/gateway.do）替换为mapi.alipay.com(https://mapi.alipay.com/gateway.do)的地址。
        //2、通知验证网关
        //（1）如果使用 https://www.alipay.com/cooperate/gateway.do?service=notify_verify，更换成https://mapi.alipay.com/gateway.do?service=notify_verify
        //（2）如果使用 http://notify.alipay.com/trade/notify_query.do?，无需更改。如果需要https接入,必须是https://mapi.alipay.com/trade/notify_query.do？
