...
{
    public partial class Return_ChinaPay : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string merOrderAmt = (MyConvert.ConToDec(Request.Form["OrderAmt"])/100).ToString();            //获取总金额
            ...
            {
                SaveErrorToLog("中国银联支付状态态错误！", "trade_status=" + tranResult);
