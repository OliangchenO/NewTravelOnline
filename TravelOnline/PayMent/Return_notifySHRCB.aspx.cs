...
{
    public partial class Return_notifySHRCB : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (tranResult.Equals("ZF0000"))
            {
                ...
                if (DS.Tables[0].Rows.Count == 0)
                {
                    ...
                    Sql.Add(string.Format("insert into OL_OrderLog (OrderId,LogTime,LogContent) values ('{0}','{1}','在线支付成功，付款金额：{2}，上海农商银行交易号：{3}')",
                        OrderID,
                        DateTime.Now.ToString(),
                        merOrderAmt,
                        tranSerialNo
